...
SELECT osm_id,
       ...
       COALESCE(NULLIF(cycleway_left_traffic_sign, ''),NULLIF(sidewalk_left_traffic_sign, '')) AS side_left_traffic_sign,
       NULLIF(COALESCE(NULLIF(cycleway_left_traffic_sign, ''),NULLIF(sidewalk_left_traffic_sign, '')) ~ '^DE.*(240|237|244.1|241)', false) AS side_left_traffic_sign_is_mandatory,
       NULLIF(COALESCE(NULLIF(cycleway_left_traffic_sign, ''),NULLIF(sidewalk_left_traffic_sign, '')) ~ '^DE.*1022-10', false) AS side_left_traffic_sign_is_optional,
       NULLIF(COALESCE(NULLIF(cycleway_left_oneway, ''),NULLIF(sidewalk_left_oneway, '')) = 'no', false) AS side_left_oneway_no,
       COALESCE(NULLIF(cycleway_right_traffic_sign, ''),NULLIF(sidewalk_right_traffic_sign, '')) AS side_right_traffic_sign,
       NULLIF(COALESCE(NULLIF(cycleway_right_traffic_sign, ''),NULLIF(sidewalk_right_traffic_sign, '')) ~ '^DE.*(240|237|244.1|241)', false) AS side_right_traffic_sign_is_mandatory,
       NULLIF(COALESCE(NULLIF(cycleway_right_traffic_sign, ''),NULLIF(sidewalk_right_traffic_sign, '')) ~ '^DE.*1022-10', false) AS side_right_traffic_sign_is_optional,
