...
CREATE OR REPLACE FUNCTION layer_transportation(bbox geometry, zoom_level int)
    RETURNS TABLE
            (
                ...
                side_left_traffic_sign text,
                side_left_traffic_sign_is_mandatory boolean,
                side_left_traffic_sign_is_optional boolean,
                side_left_oneway_no boolean,
                side_right_traffic_sign text,
                side_right_traffic_sign_is_mandatory boolean,
                side_right_traffic_sign_is_optional boolean,
                side_right_oneway_no boolean,
                width      float,
...
SELECT osm_id,
       ...
       normalize_traffic_sign(NULLIF(traffic_sign_all, '')) AS traffic_sign_all,
       traffic_sign_is_mandatory(traffic_sign_all) AS traffic_sign_is_mandatory,
       traffic_sign_is_optional(traffic_sign_all) AS traffic_sign_is_optional,
       normalize_traffic_sign(COALESCE(NULLIF(cycleway_left_traffic_sign, ''),NULLIF(sidewalk_left_traffic_sign, ''))) AS side_left_traffic_sign,
       traffic_sign_is_mandatory(COALESCE(NULLIF(cycleway_left_traffic_sign, ''),NULLIF(sidewalk_left_traffic_sign, ''))) AS side_left_traffic_sign_is_mandatory,
       traffic_sign_is_optional(COALESCE(NULLIF(cycleway_left_traffic_sign, ''),NULLIF(sidewalk_left_traffic_sign, ''))) AS side_left_traffic_sign_is_optional,
       NULLIF(COALESCE(NULLIF(cycleway_left_oneway, ''),NULLIF(sidewalk_left_oneway, '')) = 'no', false) AS side_left_oneway_no,
       normalize_traffic_sign(COALESCE(NULLIF(cycleway_right_traffic_sign, ''),NULLIF(sidewalk_right_traffic_sign, ''))) AS side_right_traffic_sign,
       traffic_sign_is_mandatory(COALESCE(NULLIF(cycleway_right_traffic_sign, ''),NULLIF(sidewalk_right_traffic_sign, ''))) AS side_right_traffic_sign_is_mandatory,
       traffic_sign_is_optional(COALESCE(NULLIF(cycleway_right_traffic_sign, ''),NULLIF(sidewalk_right_traffic_sign, ''))) AS side_right_traffic_sign_is_optional,
       NULLIF(COALESCE(NULLIF(cycleway_right_oneway, ''),NULLIF(sidewalk_right_oneway, '')) = 'no', false) AS side_right_oneway_no,
...
FROM (
         ...
         SELECT osm_id,
                ...
                NULL AS cycleway_left_traffic_sign,
                NULL AS sidewalk_left_traffic_sign,
                NULL AS cycleway_left_oneway,
                NULL AS sidewalk_left_oneway,
                NULL AS cycleway_right_traffic_sign,
                NULL AS sidewalk_right_traffic_sign,
                NULL AS cycleway_right_oneway,
                NULL AS sidewalk_right_oneway,
                NULL AS width,
         ...
         SELECT osm_id,
                ...
                bicycle_forward(bicycle, bicycle_forward, sidewalk_bicycle, sidewalk_both_bicycle, sidewalk_right_bicycle, sidewalk_left_bicycle, sidewalk_left_oneway, cycleway_both, cycleway_left, cycleway_right, cycleway_right_traffic_sign, cycleway_left_oneway, cycleway_left_traffic_sign) AS bicycle_forward,
                bicycle_backward(bicycle, bicycle_backward, sidewalk_bicycle, sidewalk_both_bicycle, sidewalk_left_bicycle, sidewalk_right_bicycle, sidewalk_right_oneway, cycleway_both, cycleway_left, cycleway_right, cycleway_left_traffic_sign, cycleway_right_oneway, cycleway_right_traffic_sign) AS bicycle_backward,
                ...
                cycleway_left(cycleway, cycleway_both, cycleway_left, sidewalk_bicycle, sidewalk_both_bicycle, sidewalk_left_bicycle, sidewalk_right_bicycle, sidewalk_right_oneway) AS cycleway_left,
                cycleway_right(cycleway, cycleway_both, cycleway_right, sidewalk_bicycle, sidewalk_both_bicycle, sidewalk_right_bicycle, sidewalk_left_bicycle, sidewalk_left_oneway) AS cycleway_right,
